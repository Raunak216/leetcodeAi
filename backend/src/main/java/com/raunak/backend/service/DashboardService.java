...
import com.fasterxml.jackson.core.type.TypeReference;import com.raunak.backend.dto.TopicMastery;
@Service
public class DashboardService {
    ...
    public DashboardService(
            QuestionAttemptRepository repository,UserRepository userRepository,SkillProfileRepository skillProfileRepository
    ...
    private Map<String,SkillValue> getAllSkills(
            SkillProfile profile
    ) throws Exception{

        Map<String,SkillValue> all =
                new HashMap<>();
    ...
    public DashboardResponse getDashboard(
        ...
        response.setStrongTopics(
                getStrongTopics(profile)
        );

        response.setWeakTopics(
                getWeakTopics(profile)
        );

        response.setUnexploredTopics(
                getUnexploredTopics(profile)
        );
